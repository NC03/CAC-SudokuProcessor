...
public class ImageCropper extends JFrame
{
    ...
    {
        try{
            BufferedImage bi = ImageIO.read(new File("/home/nc/Desktop/SudokuNYT.png"));
    ...
    public BufferedImage getCroppedImage()
    {
        ...
        int x1 = (int)(inputImage.getWidth()*((double)Math.min(coordinates[0][0],coordinates[1][0])-bounds[0][0])/viewportWidth);
    ...
    public static BufferedImage resize(BufferedImage bi, int width, int height)
    {
        ...
        for(int i = 0; i < out.getHeight(); i++)
        {
            for(int j =0; j < out.getWidth(); j++)
            {
                ...
                Color[] colors = 
                    {
                        new Color(bi.getRGB(minX,minY)),
                        new Color(bi.getRGB(maxX,minY)),
                        new Color(bi.getRGB(minX,maxY)),
                        new Color(bi.getRGB(maxX,maxY))
                    };
    ...
    public void paint(Graphics g)
    {
        ...
        scaledImage = resize(inputImage,(int)(inputImage.getWidth()*scalar),(int)(inputImage.getHeight()*scalar));
